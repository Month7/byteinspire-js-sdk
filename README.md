...
```html
<script type="text/javascript" src="https://unpkg.com/@byteinspire/js-sdk@0.2.3/dist/inspirecloud.min-0.2.3.js"></script>
```
...
1. 点击打开 [https://unpkg.com/@byteinspire/js-sdk@0.2.3/dist/inspirecloud.min-0.2.3.js](https://unpkg.com/@byteinspire/js-sdk@0.2.3/dist/inspirecloud.min-0.2.3.js) 并下载 JS 文件，移动到小程序 `libs` 目录。
2. 在小程序中：
    ```javascript
    // 注意填写正确的相对路径
...
```
import Inspirecloud from '@byteinspire/js-sdk/dist/inspirecloud-0.2.3.js'
```

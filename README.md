...
```html
<script type="text/javascript" src="https://unpkg.com/@byteinspire/js-sdk@0.5.0/dist/inspirecloud-0.5.0.min.js"></script>
```
...
1. 点击打开 [https://unpkg.com/@byteinspire/js-sdk@0.5.0/dist/inspirecloud-0.5.0.min.js](https://unpkg.com/@byteinspire/js-sdk@0.5.0/dist/inspirecloud-0.5.0.min.js) 并下载 JS 文件，移动到小程序 `libs` 目录。
2. 在小程序中：
    ```javascript
    // 注意填写正确的相对路径
    const InspireCloud = require('./libs/inspirecloud-0.5.0.min.js');
    ```
...
```
import Inspirecloud from '@byteinspire/js-sdk/dist/inspirecloud-0.5.0.min.js'
```
